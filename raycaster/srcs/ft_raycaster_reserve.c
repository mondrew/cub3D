...
/*   Updated: 2020/07/02 17:35:14 by mondrew          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Функция, которая решает - печатать или сохранить картинку
// Сначала все пиксели записываются в массив array, а потом решается - на экран или в картинку
void	ft_pixels_to_array(t_cub *scene)
{
}
		if (scene->line_len_h < scene->line_len_v)
		{
